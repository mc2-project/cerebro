...
def plot_dpi_ictf():
    ...
    plt.plot(x, y2, linestyle='solid', marker='o', markersize=5, color=blue, label="Quadratic ($n=10$)")

    plt.plot(x, y3, linestyle='solid', marker='s', markersize=5, color=green, label="Linear")
    ...
    plt.xlabel("\% of vectorized mult in 100Mbps network", fontsize=15)
