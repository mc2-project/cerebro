...
opcodes = dict(
    ...
    # This is taken from AG-MPC
    NOTSGC = 0x300,
    ANDSGC = 0x301,
    XORSGC = 0x302,
)

# BEGIN interface to AG-MPC

class nots_gc(base.Instruction):
    __slots__ = []
    
    code = opcodes['NOTSGC']
    arg_format = ['sbw', 'sb', 'sb']

class ands_gc(base.Instruction):
    __slots__ = []
    
    code = opcodes['ANDSGC']
    arg_format = ['sbw', 'sb', 'sb']

class xors_gc(base.Instruction):
    __slots__ = []
